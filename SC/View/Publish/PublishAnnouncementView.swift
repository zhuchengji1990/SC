...
struct PublishAnnouncementView: View {
...
struct PublishAnnouncementView_Previews: PreviewProvider {
    static var previews: some View {
        PublishAnnouncementView().environmentObject(Store.shared)
    }
}
